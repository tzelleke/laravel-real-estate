    ...
    <div class="container-fluid py-5">
        ...
        <div class="p-5 mb-4 bg-body-tertiary rounded-3">
            ...
            <p class="col-md-8 fs-4">
                this is a demo project featuring a backend built with Laravel
                and PostgreSQL and a frontend built with Vue 3 (Composition API)
                and Bootstrap 5.
            </p>
            ...
            <div class="col-md-6">
                <div class="h-100 p-5 text-bg-dark rounded-3">
                    ...
                    <p>
                        ...
                        color utility to mix up the jumbotron look. Then, mix
                        and match with additional component themes and more.
                    </p>
